...
import BraintreeForm from '.'
import { storiesOf } from '@storybook/react'
import { object } from '@storybook/addon-knobs'
import { action } from '@storybook/addon-actions'

storiesOf('📦 Components/Checkout/BraintreeForm', module).add('Default', () => {
    ...
    return <BraintreeForm options={options} submitButton={{ text: 'Save' }} onSubmit={action('onSubmit')} />
})
